...
The pattern matching syntax comes from [Haskell](https://en.wikibooks.org/wiki/Haskell/Pattern_matching) (though dub's matching is not greedy). It shares the semantics of `list()`.
...
- To make the code short—around 40 lines—there are no bells and whistles, and no explicit validation.
