...
_dub_ is a small, single-purpose R package for _unpacking assignment_: it provides an operator `%<=%` that enables you to assign (nested) components of a list (or vector) to names via pattern matching. Think of `<=` as a pictograph representing multiple `<-`'s.
...
If you need a more full-featured option for unpacking assignment, I recommend
